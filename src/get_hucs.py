...
def get_hucs(level='huc10', sample_size=None, random_seed=None, filter_prefix=None):
    ...
    ----------
    level : str
        HUC level to process. Options: 'huc2', 'huc4', 'huc6', 'huc8', 'huc10', 'huc12'
    ...
    # Validate level
    valid_levels = {'huc2': 2, 'huc4': 4, 'huc6': 6, 'huc8': 8, 'huc10': 10, 'huc12': 12}
    ...
    try:
        ...
        raise FileNotFoundError("HUC data file not found. Please ensure 'huc10s.csv' exists.")
